package multithread.performance.latency;
...
public class ImageProcessing
{
    ...
    public static void recolorPixel(BufferedImage originalImage, BufferedImage resultImage, int x, int y){
        ...
        int newRGB = createRGBFormColors(newRed,newGreen,newBlue);
    ...
    public static int createRGBFormColors(int red, int green, int blue){
        int rgb = 0;
        rgb |= blue;
        rgb |=green << 8;
        rgb |= red<<16;
